...
public final class Statement implements java.sql.Statement
{
   ...
   // Execute a query
   //rewised by CJC, to retrieve at most @num tuples Dec. 11, 2015
   private java.sql.ResultSet executeQueryInternal(String query,FunctionCallback callback, int num) throws SQLException{
   ...
   private java.sql.ResultSet executeQueryInternal(String query,FunctionCallback callback) throws SQLException{
	      synchronized (connection) {}
	    	  return executeQueryInternal(query, callback, -1);
   }
   
   //added by CJC, return at most @num tuples
   public java.sql.ResultSet executeQuery(String query, int num) throws SQLException{
      return executeQueryInternal(query, null, num);
   }
